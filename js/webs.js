...
function createPostSummary(A, z, u) {
    ...
    if (t.indexOf("img.youtube.com") != -1) {
        D = '<div class="thumbimage imglatest"><a class="thumbimgx" title="' + p + '" href="' + E + '"><span class="mark"><i class="fa fa-link"></i></span><img onload="resizeimage(event);" class="post-thumbnail" src="' + t.replace("default", "0") + '" alt="' + p + '"><span class="youtubeplay"><i class="icon-youtube-play"></i></span></a></div>'
    }
    l = j.replace(/<(.*?)>/g, "")
        .replace(/[\n\r]+/g, " ");
                        ...
                        w.find(".post-summary")
                            .each(function () {
                                ...
                                if (K.indexOf("img.youtube.com") != -1) {
                                    B = '<div class="thumbimage imglatest"><a class="thumbimgx" title="' + titlex + '" href="' + R + '"><span class="mark"><i class="fa fa-link"></i></span><img onload="resizeimage(event);" class="post-thumbnail" src="' + K.replace("default", "0") + '" alt="' + titlex + '"><span class="youtubeplay"><i class="icon-youtube-play"></i></span></a></div>'
                                }
                ...
                c(d.Container)
                    ...
                    .each(function () {
                        ...
                        if (xlink.indexOf("img.youtube.com") != -1 && !xadami.length) {
                            xparents.append('<span class="youtubeplay"><i class="icon-youtube-play"></i></span>')
                        }
                    });
                ...
                c(".ticknews li")
                    .mouseenter(function () {
                        ...
                        var l = c(this)
                            .attr("data-comment");
                        c(".postinfo")
                            .html('<div class="inner"><img src="' + F + '"/><strong>' + G + '</strong><span><i class="icon-time"></i> ' + i + ' <i class="icon-comment"></i> ' + l + "</span><p>" + j + "</p></div>");
                        c(".postinfo")
                            .filter(":not(:animated)")
                            .fadeIn(700)
                    })
                            ...
                            f.$el.find(".rcbytag .infonya")
                                .mouseenter(function () {
                                    ...
                                    var Q = c(this)
                                        .attr("data-comment");
                                    c(".postinfo")
                                        .html('<div class="inner"><img src="' + R + '"/><strong>' + S + '</strong><span><i class="icon-time"></i> ' + l + ' <i class="icon-comment"></i> ' + Q + "</span><p>" + P + "</p></div>");
                                    c(".postinfo")
                                        .filter(":not(:animated)")
                                        .fadeIn(700)
                                })
...
function relatedPostsWidget(a) {
    (function (e) {
        ...
        var k = function (r, v, x, n, z, w, y) {
            ...
            g.append('<li><div class="inner"><a class="jdlunya" href="' + r + '" title="' + (f.relevantTip ? f.relevantTip.replace("\d", 1) : "") + '"><div class="thumbimage rltdimg"><span class="gmbrrltd"><img onload="resizeimage(event);" alt="' + v + '" src="' + x + '"/></span></div><strong>' + v + "</strong></a><p>" + n + '<a title="' + v + '" href="' + r + '">' + f.readMoretext + "</a></p>" + (f.ShowDate === true ? '<span class="date"><i class="icon-time"></i><span class="dm">' + y + '</span> <span class="dd">' + w + '</span>, <span class="dy">' + z + "</span></span>" : "") + "</div></li>")
        };
        var j = function (m) {
